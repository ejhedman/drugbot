...
export function LoginForm({ onSuccess }: LoginFormProps) {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-accent border border-accent p-8 w-full max-w-md">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-xl focus-accent"
